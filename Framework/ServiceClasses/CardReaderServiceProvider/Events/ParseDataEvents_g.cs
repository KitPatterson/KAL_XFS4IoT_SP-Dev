 ...
 * ParseDataEvents_g.cs uses automatically generated parts. 
...
{
    internal class ParseDataEvents : CardReaderEvents, IParseDataEvents
    {

        public ParseDataEvents(IConnection connection, string requestId)
