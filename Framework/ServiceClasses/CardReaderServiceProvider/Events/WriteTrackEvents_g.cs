 ...
 * WriteTrackEvents_g.cs uses automatically generated parts. 
...
{
    internal class WriteTrackEvents : CardReaderEvents, IWriteTrackEvents
    {

        public WriteTrackEvents(IConnection connection, string requestId)
