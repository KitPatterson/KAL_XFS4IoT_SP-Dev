...
namespace XFS4IoTFramework.CardReader
{
    ...
    public partial class EMVClessIssuerUpdateHandler : ICommandHandler
    {
        public EMVClessIssuerUpdateHandler(ICommandDispatcher Dispatcher, ILogger logger)
        {
            ...
            Provider.IsNotNull($"Invalid parameter received in the {nameof(EMVClessIssuerUpdateHandler)} constructor. {nameof(Provider)}");
            ...
            Device.IsNotNull($"Invalid parameter received in the {nameof(EMVClessIssuerUpdateHandler)} constructor. {nameof(Device)}");
