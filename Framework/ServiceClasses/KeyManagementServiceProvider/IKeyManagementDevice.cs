...
namespace XFS4IoTFramework.KeyManagement
{
    public interface IKeyManagementDevice : IDevice
    {
        ...
        /// </summary>
        Task<ImportKeyResult> ImportKeyPart(IImportKeyEvents events,
                                            ImportKeyPartRequest request,
        ...
        /// </summary>
        Task<ImportKeyResult> ImportKey(IImportKeyEvents events,
        ...
        /// </summary>
        Task<InitializationResult> Initialization(IInitializationEvents events, 
        ...
        /// </summary>
        Task<DeriveKeyCompletion.PayloadData> DeriveKey(IDeriveKeyEvents events, 
        ...
        /// </summary>
        Task<ResetCompletion.PayloadData> Reset(IResetEvents events, 
        ...
        /// </summary>
        Task<DeleteKeyCompletion.PayloadData> DeleteKey(IDeleteKeyEvents events, 
        ...
        /// </summary>
        Task<ExportRSAIssuerSignedItemCompletion.PayloadData> ExportRSAIssuerSignedItem(IExportRSAIssuerSignedItemEvents events, 
        ...
        /// </summary>
        Task<GenerateRSAKeyPairCompletion.PayloadData> GenerateRSAKeyPair(IGenerateRSAKeyPairEvents events, 
        ...
        /// </summary>
        Task<ExportRSAEPPSignedItemCompletion.PayloadData> ExportRSAEPPSignedItem(IExportRSAEPPSignedItemEvents events, 
        ...
        /// </summary>
        Task<GetCertificateCompletion.PayloadData> GetCertificate(IGetCertificateEvents events, 
        ...
        /// </summary>
        Task<ReplaceCertificateCompletion.PayloadData> ReplaceCertificate(IReplaceCertificateEvents events, 
        ...
        /// </summary>
        Task<StartKeyExchangeCompletion.PayloadData> StartKeyExchange(IStartKeyExchangeEvents events, 
        ...
        /// </summary>
        Task<GenerateKCVCompletion.PayloadData> GenerateKCV(IGenerateKCVEvents events, 
        ...
        /// </summary>
        Task<LoadCertificateCompletion.PayloadData> LoadCertificate(ILoadCertificateEvents events, 
        ...
        /// </summary>
        Task<StartAuthenticateCompletion.PayloadData> StartAuthenticate(IStartAuthenticateEvents events, 
