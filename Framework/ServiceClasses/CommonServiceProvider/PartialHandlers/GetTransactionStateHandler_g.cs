...
namespace XFS4IoTFramework.Common
{
    ...
    public partial class GetTransactionStateHandler : ICommandHandler
    {
        public GetTransactionStateHandler(ICommandDispatcher Dispatcher, ILogger logger)
        {
            ...
            Provider.IsNotNull($"Invalid parameter received in the {nameof(GetTransactionStateHandler)} constructor. {nameof(Provider)}");
            ...
            Device.IsNotNull($"Invalid parameter received in the {nameof(GetTransactionStateHandler)} constructor. {nameof(Device)}");
        ...
        public async Task Handle(IConnection Connection, object command, CancellationToken cancel)
        {
            ...
            await HandleGetTransactionState(Connection, getTransactionStateCmd, cancel);
        }
