...
namespace XFS4IoTFramework.Common
{
    public interface ICommonDevice : IDevice
    {
        ...
        /// </summary>
        Task<XFS4IoT.Common.Completions.PowerSaveControlCompletion.PayloadData> PowerSaveControl(XFS4IoT.Common.Commands.PowerSaveControlCommand.PayloadData payload);

        /// <summary>
        /// {}
        /// </summary>
        Task<XFS4IoT.Common.Completions.SynchronizeCommandCompletion.PayloadData> SynchronizeCommand(XFS4IoT.Common.Commands.SynchronizeCommandCommand.PayloadData payload);
        ...
        /// </summary>
        Task<XFS4IoT.Common.Completions.SetTransactionStateCompletion.PayloadData> SetTransactionState(XFS4IoT.Common.Commands.SetTransactionStateCommand.PayloadData payload);
        ...
        /// </summary>
        Task<GetCommandRandomNumberHandler.GetCommandRandomNumberResult> GetCommandRandomNumber();
