...
namespace XFS4IoTFramework.Common
{
    public partial class CancelHandler
    {
        ...
        private Task<CancelCompletion.PayloadData> HandleCancel(ICancelEvents events, CancelCommand cancel, CancellationToken cancel)
        {
            ...
            #if DEBUG
                throw new NotImplementedException("HandleCancel for Common is not implemented in CancelHandler.cs");
            #else
                #error HandleCancel for Common is not implemented in CancelHandler.cs
            #endif
        }
