...
namespace XFS4IoTFramework.CardReader
{
    public interface ICardReaderDevice : ICommonDevice
    {
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.FormListPayload> FormList(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.FormListPayload payload, CancellationToken cancellation);

        /// <summary>
        /// This command is used to retrieve details of the definition of a specified form.
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.QueryFormPayload> QueryForm(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.QueryFormPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.QueryIFMIdentifierPayload> QueryIFMIdentifier(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.QueryIFMIdentifierPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.EMVClessQueryApplicationsPayload> EMVClessQueryApplications(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.EMVClessQueryApplicationsPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.ReadTrackPayload> ReadTrack(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.ReadTrackPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.WriteTrackPayload> WriteTrack(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.WriteTrackPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.EjectCardPayload> EjectCard(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.EjectCardPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.RetainCardPayload> RetainCard(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.RetainCardPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.ResetCountPayload> ResetCount(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.ResetCountPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.SetKeyPayload> SetKey(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.SetKeyPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.ReadRawDataPayload> ReadRawData(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.ReadRawDataPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.WriteRawDataPayload> WriteRawData(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.WriteRawDataPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.ChipIOPayload> ChipIO(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.ChipIOPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.ResetPayload> Reset(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.ResetPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.ChipPowerPayload> ChipPower(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.ChipPowerPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.ParseDataPayload> ParseData(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.ParseDataPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.ParkCardPayload> ParkCard(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.ParkCardPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.EMVClessConfigurePayload> EMVClessConfigure(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.EMVClessConfigurePayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.EMVClessPerformTransactionPayload> EMVClessPerformTransaction(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.EMVClessPerformTransactionPayload payload, CancellationToken cancellation);
        ...
        /// </summary>
        Task<XFS4IoT.CardReader.Responses.EMVClessIssuerUpdatePayload> EMVClessIssuerUpdate(ICardReaderConnection connection, XFS4IoT.CardReader.Commands.EMVClessIssuerUpdatePayload payload, CancellationToken cancellation);
