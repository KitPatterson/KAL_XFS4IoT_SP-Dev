...
namespace XFS4IoTFramework.TextTerminal
{
    ...
    public partial class SetResolutionHandler : ICommandHandler
    {
        public SetResolutionHandler(ICommandDispatcher Dispatcher, ILogger logger)
        {
            ...
            Provider.IsNotNull($"Invalid parameter received in the {nameof(SetResolutionHandler)} constructor. {nameof(Provider)}");
            ...
            Device.IsNotNull($"Invalid parameter received in the {nameof(SetResolutionHandler)} constructor. {nameof(Device)}");
