...
namespace XFS4IoTFramework.TextTerminal
{
    ...
    public partial class BeepHandler : ICommandHandler
    {
        public BeepHandler(ICommandDispatcher Dispatcher, ILogger logger)
        {
            ...
            Provider.IsNotNull($"Invalid parameter received in the {nameof(BeepHandler)} constructor. {nameof(Provider)}");
            ...
            Device.IsNotNull($"Invalid parameter received in the {nameof(BeepHandler)} constructor. {nameof(Device)}");
