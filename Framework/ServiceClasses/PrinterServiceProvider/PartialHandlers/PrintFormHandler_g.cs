...
namespace XFS4IoTFramework.Printer
{
    ...
    public partial class PrintFormHandler : ICommandHandler
    {
        public PrintFormHandler(ICommandDispatcher Dispatcher, ILogger logger)
        {
            ...
            Provider.IsNotNull($"Invalid parameter received in the {nameof(PrintFormHandler)} constructor. {nameof(Provider)}");
            ...
            Device.IsNotNull($"Invalid parameter received in the {nameof(PrintFormHandler)} constructor. {nameof(Device)}");
