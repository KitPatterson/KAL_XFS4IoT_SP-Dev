...
namespace XFS4IoTFramework.Printer
{
    ...
    public partial class GetMediaListHandler : ICommandHandler
    {
        public GetMediaListHandler(ICommandDispatcher Dispatcher, ILogger logger)
        {
            ...
            Provider.IsNotNull($"Invalid parameter received in the {nameof(GetMediaListHandler)} constructor. {nameof(Provider)}");
            ...
            Device.IsNotNull($"Invalid parameter received in the {nameof(GetMediaListHandler)} constructor. {nameof(Device)}");
