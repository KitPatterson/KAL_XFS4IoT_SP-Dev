...
namespace XFS4IoTFramework.CashManagement
{
    ...
    public partial class GetTellerInfoHandler : ICommandHandler
    {
        ...
        public async Task Handle(IConnection Connection, object command, CancellationToken cancel)
        {
            ...
            IGetTellerInfoEvents events = new GetTellerInfoEvents(Connection, getTellerInfoCmd.Headers.RequestId);

            var result = await HandleGetTellerInfo(events, getTellerInfoCmd, cancel);
            await Connection.SendMessageAsync(new GetTellerInfoCompletion(getTellerInfoCmd.Headers.RequestId, result));
        }
        ...
        public async Task HandleError(IConnection connection, object command, Exception commandException)
        {
            ...
            var response = new GetTellerInfoCompletion(getTellerInfocommand.Headers.RequestId, new GetTellerInfoCompletion.PayloadData(errorCode, commandException.Message));
