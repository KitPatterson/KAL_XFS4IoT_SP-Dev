...
namespace XFS4IoTFramework.CashManagement
{
    ...
    public partial class GetCashUnitInfoHandler : ICommandHandler
    {
        ...
        public async Task Handle(IConnection Connection, object command, CancellationToken cancel)
        {
            ...
            IGetCashUnitInfoEvents events = new GetCashUnitInfoEvents(Connection, getCashUnitInfoCmd.Headers.RequestId);

            var result = await HandleGetCashUnitInfo(events, getCashUnitInfoCmd, cancel);
            await Connection.SendMessageAsync(new GetCashUnitInfoCompletion(getCashUnitInfoCmd.Headers.RequestId, result));
        }
        ...
        public async Task HandleError(IConnection connection, object command, Exception commandException)
        {
            ...
            var response = new GetCashUnitInfoCompletion(getCashUnitInfocommand.Headers.RequestId, new GetCashUnitInfoCompletion.PayloadData(errorCode, commandException.Message));
