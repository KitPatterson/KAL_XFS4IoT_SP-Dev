...
namespace XFS4IoTFramework.Dispenser
{
    public partial class GetPresentStatusHandler
    {
        ...
        {
            //ToDo: Implement HandleGetPresentStatus for Dispenser.
            
            #if DEBUG
                throw new NotImplementedException("HandleGetPresentStatus for Dispenser is not implemented in GetPresentStatusHandler.cs");
            #else
                #error HandleGetPresentStatus for Dispenser is not implemented in GetPresentStatusHandler.cs
            #endif
        }
