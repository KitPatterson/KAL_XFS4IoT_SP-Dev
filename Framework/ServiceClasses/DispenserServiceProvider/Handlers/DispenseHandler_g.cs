...
namespace XFS4IoTFramework.Dispenser
{
    ...
    public partial class DispenseHandler : ICommandHandler
    {
        ...
        public async Task Handle(IConnection Connection, object command, CancellationToken cancel)
        {
            ...
            IDispenseEvents events = new DispenseEvents(Connection, dispenseCmd.Headers.RequestId);

            var result = await HandleDispense(events, dispenseCmd, cancel);
            await Connection.SendMessageAsync(new DispenseCompletion(dispenseCmd.Headers.RequestId, result));
        }
        ...
        public async Task HandleError(IConnection connection, object command, Exception commandException)
        {
            ...
            var response = new DispenseCompletion(dispensecommand.Headers.RequestId, new DispenseCompletion.PayloadData(errorCode, commandException.Message));
