...
namespace XFS4IoTFramework.Dispenser
{
    ...
    public partial class GetMixTableHandler : ICommandHandler
    {
        ...
        public async Task Handle(IConnection Connection, object command, CancellationToken cancel)
        {
            ...
            IGetMixTableEvents events = new GetMixTableEvents(Connection, getMixTableCmd.Headers.RequestId);

            var result = await HandleGetMixTable(events, getMixTableCmd, cancel);
            await Connection.SendMessageAsync(new GetMixTableCompletion(getMixTableCmd.Headers.RequestId, result));
        }
        ...
        public async Task HandleError(IConnection connection, object command, Exception commandException)
        {
            ...
            var response = new GetMixTableCompletion(getMixTablecommand.Headers.RequestId, new GetMixTableCompletion.PayloadData(errorCode, commandException.Message));
