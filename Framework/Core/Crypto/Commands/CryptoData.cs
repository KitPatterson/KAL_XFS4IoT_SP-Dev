...
namespace XFS4IoT.Crypto.Commands
{
    ...
    public sealed class CryptoDataCommand : Command<CryptoDataCommand.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            public PayloadData(int Timeout, string Key = null, string StartValueKey = null, string StartValue = null, int? Padding = null, bool? Compression = null, string CryptData = null, object CryptoAttributes = null)
                : base(Timeout)
            {
                this.Key = Key;
