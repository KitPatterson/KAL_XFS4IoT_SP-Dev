...
namespace XFS4IoT.Crypto.Commands
{
    ...
    public sealed class GenerateAutheticationCommand : Command<GenerateAutheticationCommand.PayloadData>
    {
        public GenerateAutheticationCommand(string RequestId, GenerateAutheticationCommand.PayloadData Payload)
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            public PayloadData(int Timeout, string Key = null, string StartValueKey = null, string StartValue = null, int? Padding = null, bool? Compression = null, string CryptData = null, string VerifyData = null, object SignatureAttributes = null)
                : base(Timeout)
            {
                this.Key = Key;
