...
namespace XFS4IoT.Crypto.Commands
{
    ...
    public sealed class GenerateAuthenticationCommand : Command<GenerateAuthenticationCommand.PayloadData>
    {
        ...
        {
            /// <summary>
            ///This parameter specifies the encryption algorithm, cryptographic method, and mode to be used for this command. For a list of valid values see the Attributes [Crypto.capability](#common.capabilities.completion.properties.crypto.authenticationattributes) field. The values specified must be compatible with the key identified by Key.
            /// </summary>
