...
namespace XFS4IoT.TextTerminal.Commands
{
	...
	public sealed class WriteForm : Command<WriteFormPayload>
	{
	...
	public sealed class WriteFormPayload : MessagePayload
	{
		...
		public WriteFormPayload(int Timeout, string FormName = null, bool? ClearScreen = null, List<string> Fields = null)
			: base(Timeout)
		{
