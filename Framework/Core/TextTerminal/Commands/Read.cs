...
namespace XFS4IoT.TextTerminal.Commands
{
	...
	public sealed class Read : Command<ReadPayload>
	{
	...
	public sealed class ReadPayload : MessagePayload
	{
		...
		public ReadPayload(int Timeout, int? NumOfChars = null, ModeEnum? Mode = null, int? PosX = null, int? PosY = null, EchoModeEnum? EchoMode = null, object EchoAttr = null, bool? Echo = null, bool? Flush = null, bool? AutoEnd = null, string ActiveKeys = null, List<string> ActiveCommandKeys = null, List<string> TerminateCommandKeys = null)
			: base(Timeout)
		{
