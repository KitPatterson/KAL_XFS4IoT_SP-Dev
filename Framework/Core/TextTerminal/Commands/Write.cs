...
namespace XFS4IoT.TextTerminal.Commands
{
	...
	public sealed class Write : Command<WritePayload>
	{
	...
	public sealed class WritePayload : MessagePayload
	{
		...
		public WritePayload(int Timeout, ModeEnum? Mode = null, int? PosX = null, int? PosY = null, object TextAttr = null, string Text = null)
			: base(Timeout)
		{
			this.Mode = Mode;
			this.PosX = PosX;
