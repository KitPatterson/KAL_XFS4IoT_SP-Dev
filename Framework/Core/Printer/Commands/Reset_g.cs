...
namespace XFS4IoT.Printer.Commands
{
    ...
    public sealed class ResetCommand : Command<ResetCommand.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            /// <summary>
            ///Specifies the manner in which the media should be handled, as one of the following:* ```eject``` - Eject the media.* ```retract``` - Retract the media to retract bin number specified.* ```expel``` - Throw the media out of the exit slot.
            /// </summary>
            [DataMember(Name = "mediaControl")] 
            public MediaControlEnum? MediaControl { get; private set; }
            /// <summary>
            ///Number of the retract bin the media is retracted to. This number has to be between one and the[number of bins](#common.capabilities.completion.properties.printer.retractbins) supported by thisdevice. It is only relevant if [mediaControl](#printer.reset.command.properties.mediacontrol) is*retract*.
            /// </summary>
