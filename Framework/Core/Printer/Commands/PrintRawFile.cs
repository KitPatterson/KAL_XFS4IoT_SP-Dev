...
namespace XFS4IoT.Printer.Commands
{
	...
	public sealed class PrintRawFile : Command<PrintRawFilePayload>
	{
	...
	public sealed class PrintRawFilePayload : MessagePayload
	{
		...
		public PrintRawFilePayload(int Timeout, string FileName = null, object MediaControl = null, PaperSourceEnum? PaperSource = null)
			: base(Timeout)
		{
