...
namespace XFS4IoT.Printer.Commands
{
    ...
    public sealed class ControlMediaCommand : Command<ControlMediaCommand.PayloadData>
    {
        ...
        {
            /// <summary>
            ///Specifies the manner in which the media should be handled, as a combination of the following flags:It is not possible to combine the flags eject, retract, park, expel and ejectToTransport with eachother otherwise the command completes with errInvalidData.It is not possible to combine the flag[clearBuffer](#printer.controlmedia.command.properties.mediacontrol.clearbuffer) with any other flags,otherwise the command completes with *invalidData*.An application should be aware that the sequence of the actions is not guaranteed if more than oneflag is specified in this parameter.
            /// </summary>
