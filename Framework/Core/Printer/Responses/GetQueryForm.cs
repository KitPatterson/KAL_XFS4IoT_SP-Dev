...
namespace XFS4IoT.Printer.Responses
{
	...
	[DataContract]
	[Response(Name = "Printer.GetQueryForm")]
	...
	public sealed class GetQueryFormPayload : MessagePayload
	{
		...
		public GetQueryFormPayload(CompletionCodeEnum CompletionCode, string ErrorDescription, string FormName = null, BaseEnum? Base = null, int? UnitX = null, int? UnitY = null, int? Width = null, int? Height = null, AlignmentEnum? Alignment = null, OrientationEnum? Orientation = null, int? OffsetX = null, int? OffsetY = null, int? VersionMajor = null, int? VersionMinor = null, string UserPrompt = null, List<string> Fields = null)
