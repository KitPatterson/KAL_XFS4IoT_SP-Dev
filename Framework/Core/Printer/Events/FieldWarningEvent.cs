...
namespace XFS4IoT.Printer.Events
{
	...
	public sealed class FieldWarningEvent : Event<FieldWarningEventPayload>
	{

		public FieldWarningEvent(string RequestId, FieldWarningEventPayload Payload)
	...
	[DataContract]
	public sealed class FieldWarningEventPayload : MessagePayloadBase
	{
		...
		public FieldWarningEventPayload(string FormName = null, string FieldName = null, FailureEnum? Failure = null)
			: base()
		{
