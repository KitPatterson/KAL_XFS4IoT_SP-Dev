...
namespace XFS4IoT.Dispenser.Events
{
    ...
    [DataContract]
    [Event(Name = "Dispenser.CashUnitInfoChangedEvent")]
    public sealed class CashUnitInfoChangedEvent : Event<CashUnitInfoChangedEvent.PayloadData>
    {

        public CashUnitInfoChangedEvent(string RequestId, PayloadData Payload)
        ...
        public sealed class PayloadData : MessagePayloadBase
        {
            ...
            public object NoteNumberList { get; private set; }
            /// <summary>
