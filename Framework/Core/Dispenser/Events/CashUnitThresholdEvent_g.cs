...
namespace XFS4IoT.Dispenser.Events
{
    ...
    [DataContract]
    [Event(Name = "Dispenser.CashUnitThresholdEvent")]
    public sealed class CashUnitThresholdEvent : Event<CashUnitThresholdEvent.PayloadData>
    {

        public CashUnitThresholdEvent(string RequestId, PayloadData Payload)
