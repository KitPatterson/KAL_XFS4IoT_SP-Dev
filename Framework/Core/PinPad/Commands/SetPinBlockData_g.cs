...
namespace XFS4IoT.PinPad.Commands
{
    ...
    public sealed class SetPinBlockDataCommand : Command<SetPinBlockDataCommand.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            public PayloadData(int Timeout, ErrorCodeEnum? ErrorCode = null, string CustomerData = null, string XorData = null, int? Padding = null, FormatEnum? Format = null, string Key = null, string SecondEncKey = null, PinBlockAttributeClass PinBlockAttribute = null)
                : base(Timeout)
            {
