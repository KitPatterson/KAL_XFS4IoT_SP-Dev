 ...
 * EMVClessReadStatusEvent.cs uses automatically generated parts. 
 * EMVClessReadStatusEvent.cs was created at 03/03/2021 05:09:25 PM
\***********************************************************************************************/
...
namespace XFS4IoT.CardReader.Events
{
	...
	public sealed class EMVClessReadStatusEvent : Event<EMVClessReadStatusEventPayload>
	{

		public EMVClessReadStatusEvent(string RequestId, EMVClessReadStatusEventPayload Payload)
	...
	[DataContract]
	public sealed class EMVClessReadStatusEventPayload : MessagePayloadBase
	{
		...
		public EMVClessReadStatusEventPayload(int? MessageId = null, StatusEnum? Status = null, int? HoldTime = null, ValueQualifierEnum? ValueQualifier = null, string Value = null, string CurrencyCode = null, string LanguagePreferenceData = null)
			: base()
		{
		...
		/// <summary>
		///Qualifies *value*. This data is defined by EMVCo as one of the following:**amount**
