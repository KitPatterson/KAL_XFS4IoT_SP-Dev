...
namespace XFS4IoT.CardReader.Responses
{
	...
	[DataContract]
	[Response(Name = "CardReader.ReadRawData")]
	public sealed class ReadRawData : Response<ReadRawDataPayload>
	{
	...
	public sealed class ReadRawDataPayload : MessagePayload
	{
		...
		public ReadRawDataPayload(CompletionCodeEnum CompletionCode, string ErrorDescription, StatusEnum? Status = null, List<DataClass> Data = null)
			: base(CompletionCode, ErrorDescription)
		{
			Contracts.IsNotNullOrWhitespace(ErrorDescription, $"Null or an empty value for {nameof(ErrorDescription)} in received {nameof(ReadRawDataPayload)}");
