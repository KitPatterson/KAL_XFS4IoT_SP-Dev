...
namespace XFS4IoT.CardReader.Responses
{
	...
	[DataContract]
	[Response(Name = "CardReader.EMVClessPerformTransaction")]
	public sealed class EMVClessPerformTransaction : Response<EMVClessPerformTransactionPayload>
	{
	...
	public sealed class EMVClessPerformTransactionPayload : MessagePayload
	{
		...
		public class Track1Class
		{
			...
			public class ClessOutcomeClass 
			{
				...
				public class UiOutcomeClass 
				{
					...
					/// <summary>
					///The value of the amount or balance to be displayed. If no value is to be displayed this will be  omitted.
					/// </summary>
					public class ValueClass 
					{
						...
						public QualifierEnum? Qualifier { get; private set; }
						[DataMember(Name = "display")] 
						public string Display { get; private set; }

						public ValueClass (QualifierEnum? Qualifier, string Display)
						{
					...
					public ValueClass Value { get; private set; }
					[DataMember(Name = "currencyCode")] 
					public string CurrencyCode { get; private set; }
					[DataMember(Name = "languagePreferenceData")] 
					public string LanguagePreferenceData { get; private set; }

					public UiOutcomeClass (int? MessageID, StatusEnum? Status, int? HoldTime, ValueClass Value, string CurrencyCode, string LanguagePreferenceData)
					{
				...
				public class UiRestartClass 
				{
					...
					public UiRestartClass (int? MessageID, StatusEnum? Status, int? HoldTime, ValueClass Value, string CurrencyCode, string LanguagePreferenceData)
					{
						this.MessageID = MessageID;
						this.Status = Status;
						this.HoldTime = HoldTime;
		...
		public EMVClessPerformTransactionPayload(CompletionCodeEnum CompletionCode, string ErrorDescription, Track1Class Track1 = null, Track2Class Track2 = null, Track3Class Track3 = null, ChipClass Chip = null)
			: base(CompletionCode, ErrorDescription)
		{
			Contracts.IsNotNullOrWhitespace(ErrorDescription, $"Null or an empty value for {nameof(ErrorDescription)} in received {nameof(EMVClessPerformTransactionPayload)}");
