 ...
 * WriteRawData.cs was created at 03/03/2021 05:09:25 PM
\***********************************************************************************************/
...
namespace XFS4IoT.CardReader.Commands
{
	...
	public sealed class WriteRawData : Command<WriteRawDataPayload>
	{
	...
	public sealed class WriteRawDataPayload : MessagePayload
	{
		...
		public WriteRawDataPayload(int Timeout, List<DataClass> Data = null)
			: base(Timeout)
		{
			this.Data = Data;
		}
