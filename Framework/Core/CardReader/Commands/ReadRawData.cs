 ...
 * ReadRawData.cs was created at 03/03/2021 05:09:25 PM
\***********************************************************************************************/
...
namespace XFS4IoT.CardReader.Commands
{
	...
	public sealed class ReadRawData : Command<ReadRawDataPayload>
	{

		public ReadRawData(string RequestId, ReadRawDataPayload Payload)
	...
	[DataContract]
	public sealed class ReadRawDataPayload : MessagePayload
	{


		public ReadRawDataPayload(int Timeout, bool? Track1 = null, bool? Track2 = null, bool? Track3 = null, bool? Chip = null, bool? Security = null, bool? FluxInactive = null, bool? Watermark = null, bool? MemoryChip = null, bool? Track1Front = null, bool? FrontImage = null, bool? BackImage = null, bool? Track1JIS = null, bool? Track3JIS = null, bool? Ddi = null)
			: base(Timeout)
		{
			this.Track1 = Track1;
			this.Track2 = Track2;
		...
		/// <summary>
		///If the IDC Flux Sensor is programmable it will be disabled in order to allow chip data to be read on cards which have no magnetic  stripes.
		/// </summary>
