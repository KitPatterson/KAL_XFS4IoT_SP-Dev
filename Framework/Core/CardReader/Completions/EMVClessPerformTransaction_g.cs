...
namespace XFS4IoT.CardReader.Completions
{
    ...
    public sealed class EMVClessPerformTransactionCompletion : Completion<EMVClessPerformTransactionCompletion.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            /// <summary>
            ///Contains the chip returned data formatted in as track 1. This value is set after the contactlesstransaction has been completed with mag-stripe mode.
            /// </summary>
            public class Track1Class
            {
                ...
                public class ClessOutcomeClass 
                {
                    ...
                    /// <summary>
                    ///The user interface details required to be displayed to the cardholder after processing the outcome of acontactless transaction. If no user interface details are required, this will be omitted. Please referto EMVCo Contactless Specifications for Payment Systems Book A, Section 6.2 for details of the datawithin this object.
                    /// </summary>
                    ...
                    /// <summary>
                    ///The user interface details required to be displayed to the cardholder when a transaction needs to becompleted with a re-tap. If no user interface details are required, this will be omitted.
                    /// </summary>
            ...
            /// <summary>
            ///Contains the chip returned data formatted in as track 2. This value is set after the contactlesstransaction has been completed with mag-stripe mode.
            /// </summary>
            ...
            /// <summary>
            ///Contains the chip returned data formatted in as track 3. This value is set after the contactlesstransaction has been completed with mag-stripe mode.
            /// </summary>
            ...
            /// <summary>
            ///Contains the BER-TLV formatted data read from the chip. This value is set after the contactlesstransaction has been completed with EMV mode or mag-stripe mode.
            /// </summary>
            ...
            /// <summary>
            ///Specifies the error code if applicable. The following values are possible:* ```noMedia``` - The card was removed before completion of the read operation.* ```invalidMedia``` - No track or chip was found or the card tapped cannot be used with this command  (e.g. contactless storage cards).* ```readerNotConfigured``` - This command was issued before calling  [CardReader.EMVClessConfigure](#cardreader.emvclessconfigure) command.
            /// </summary>
