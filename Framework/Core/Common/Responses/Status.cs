...
namespace XFS4IoT.Common.Responses
{
	...
	[DataContract]
	[Response(Name = "Common.Status")]
	public sealed class Status : Response<StatusPayload>
	{
	...
	public sealed class StatusPayload : MessagePayload
	{
		...
		public class CardReaderClass
		{
			...
			public CardReaderClass (MediaEnum? Media, RetainBinEnum? RetainBin, SecurityEnum? Security, int? NumberCards, ChipPowerEnum? ChipPower)
			{
				this.Media = Media;
		...
		public StatusPayload(CompletionCodeEnum CompletionCode, string ErrorDescription, CommonClass Common = null, CardReaderClass CardReader = null, CashAcceptorClass CashAcceptor = null, CashDispenserClass CashDispenser = null, CashManagementClass CashManagement = null, KeyManagementClass KeyManagement = null, KeyboardClass Keyboard = null, TextTerminalClass TextTerminal = null, PrinterClass Printer = null)
			: base(CompletionCode, ErrorDescription)
		{
			Contracts.IsNotNullOrWhitespace(ErrorDescription, $"Null or an empty value for {nameof(ErrorDescription)} in received {nameof(StatusPayload)}");
