...
namespace XFS4IoT.Common.Responses
{
	...
	[DataContract]
	[Response(Name = "Common.Capabilities")]
	public sealed class Capabilities : Response<CapabilitiesPayload>
	{
