...
namespace XFS4IoT.CashManagement.Commands
{
    ...
    {
        public GetItemInfoCommand(string RequestId, GetItemInfoCommand.PayloadData Payload)
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            /// </summary>
            public class ItemInfoTypeClass
            {
                ...
                public ItemInfoTypeClass (bool? SerialNumber, bool? Signature, bool? ImageFile)
                {
            ...
            public PayloadData(int Timeout, LevelEnum? Level = null, int? Index = null, object ItemInfoType = null)
                : base(Timeout)
            {
                this.Level = Level;
                this.Index = Index;
            ...
            public object ItemInfoType { get; private set; }
