...
namespace XFS4IoT.CashManagement.Commands
{
    ...
    {
        public SetCashUnitInfoCommand(string RequestId, SetCashUnitInfoCommand.PayloadData Payload)
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            public PayloadData(int Timeout, object Cashunits = null)
                : base(Timeout)
            {
            ...
            public object Cashunits { get; private set; }
