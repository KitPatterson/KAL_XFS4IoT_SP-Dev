...
namespace XFS4IoT.CashManagement.Completions
{
    ...
    {
        public GetCashUnitInfoCompletion(string RequestId, GetCashUnitInfoCompletion.PayloadData Payload)
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            public PayloadData(CompletionCodeEnum CompletionCode, string ErrorDescription, CashunitsClass Cashunits = null)
